        ...
        const App = () => (
            <div class="niplayer-container" ref={this.nodes.container}>
                <div class="niplayer-video-area" ref={this.nodes.videoArea} onClick={handleClick} onDblClick={handleDoubleClick}>
                    {this.config.video ? '' : <video ref={this.nodes.videoElement} autoplay muted crossOrigin="anonymous"></video>}
                </div>
                <div classList={{
                ...
                <div classList={{
                        ...
                        "hidden": this.rootStore.actionStore.state.isControllerBarHidden
